...
cwOption:SetKey("owner_chat_icon", "user_suit");
cwOption:SetKey("developer_chat_icon", "plugin");
cwOption:SetKey("operator_chat_icon", "user_add");
cwOption:SetKey("admin_chat_icon", "shield_delete");
cwOption:SetKey("super_admin_chat_icon", "shield");
cwOption:SetKey("head_admin_chat_icon", "shield_add");
...
cwOption:SetKey("developers", {"STEAM_0:1:37551949"});

--Head Admin list
cwOption:SetKey("head_admin", {"STEAM_0:0:35419952"});
...
function PLUGIN:GetPlayerIcon(player)
	...
	elseif (table.HasValue(cwOption:GetKey("head_admin"), player:SteamID())) then
		icon = cwOption:GetKey("head_admin_chat_icon");	
